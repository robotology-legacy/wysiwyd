function img_output = genMatchImageFramebyFrame_VideoSave(KineStruct_P, KineStruct_Q, X, method, pathname_P, pathname_Q)

fig_video_save_name = ['result/realSeq/',KineStruct_P.videoFileName(1:end-4),'-',KineStruct_Q.videoFileName(1:end-4),'/',KineStruct_P.videoFileName(1:end-4),'-',KineStruct_Q.videoFileName(1:end-4),'-',method];
