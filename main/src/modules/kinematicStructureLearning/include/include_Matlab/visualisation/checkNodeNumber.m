function img_output = checkNodeNumber(pathname_P, KineStruct_P, pathname_Q, KineStruct_Q)
%%
% load video
...
for i=1:KineStruct_P.num_seg
    ...
    text(KineStruct_P.seg_center(1,i,frm_idx_P) + 15, KineStruct_P.seg_center(2,i,frm_idx_P) - 15, num2str(i), 'Color', 'r');
end
...
%% P
fig_save_name = ['result/realSeq/kinematic_structure/',KineStruct_P.videoFileName(1:end-4)];
...
for i=1:KineStruct_Q.num_seg
    ...
    text(KineStruct_Q.seg_center(1,i,frm_idx_Q) + 15, KineStruct_Q.seg_center(2,i,frm_idx_Q) - 15, num2str(i), 'Color', 'r');
end
...
fig_save_name = ['result/realSeq/kinematic_structure/',KineStruct_Q.videoFileName(1:end-4)];
% saveas(h_color,fig_save_name);
% print('-depsc', fig_save_name);
export_fig(fig_save_name,'-pdf');
%%
