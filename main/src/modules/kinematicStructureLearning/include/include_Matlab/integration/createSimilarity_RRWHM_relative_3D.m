function problem = createSimilarity_RRWHM_relative_3D(KineStruct_P, KineStruct_Q)
...
system('R -f topology/Incremmental_Topologically_constrained_subisomorphism_old2.r');
...
preCompMtxP = preComputedMtx_v3_3D(KineStruct_P, method);
preCompMtxQ = preComputedMtx_v3_3D(KineStruct_Q, method);
