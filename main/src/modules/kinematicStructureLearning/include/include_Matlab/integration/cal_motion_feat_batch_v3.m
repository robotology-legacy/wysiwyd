function feat_out = cal_motion_feat_batch_v3(KineStruct, i, j, k, preCompMtx, method)
...
%         end
    ...
    case 'log'
        ...
        dist_buf = [preCompMtx{i,j,k}.cal_m_F, preCompMtx{j,k,i}.cal_m_F, preCompMtx{k,i,j}.cal_m_F] ./ norm_value;    
