...
save_path = '/home/hjchang/Research/code/Matlab/cvpr2015/result/proposed_Euclidean/trial_4/';

saveas(gcf, [save_path,filename(1:end-8),'_iter_',num2str(iter),'.pdf'], 'pdf')
