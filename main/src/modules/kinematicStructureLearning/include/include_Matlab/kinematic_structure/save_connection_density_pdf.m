...
save_path = '/home/hjchang/Dropbox/paper_writing/[2015][Journal][TPAMI] Kinematic Structure Learning/paper/figs/fig_qualitative_result/iteration_density/';

saveas(gcf, [save_path, 'Proposed_',filename,'_iter_',num2str(iter),'.pdf'], 'pdf')
