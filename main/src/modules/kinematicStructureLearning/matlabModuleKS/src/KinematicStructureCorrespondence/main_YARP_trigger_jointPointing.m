...
disp('>>>> Enter ''structureLearning2Joint #num_instance [left or right or kinect] [first frame] [last frame]''');
disp(' ');
...
disp('>>>> Enter ''findCorrespondence2Object #num_instance [left or right or kinect] #num_instance [left or right or kinect]''');
disp(' ');
...
%                 submodule_motion_segmentation;
                ...
                %----------------------------------------------------------------------
            elseif (strcmp(bCommand.get(0).toString, 'structureLearning2Joint'))     % Show Motor Joint Projection
                %%
                %=========================================================
                % YARP instruction
                %=========================================================
...
%                 wrapper_YARP_ABM_save_for_Correspondence;
                ...
                %----------------------------------------------------------------------
            elseif (strcmp(bCommand.get(0).toString, 'findCorrespondence2Object'))
                %% kinematic structure correspondences matching from two videos
                %=========================================================
                % YARP instruction
                %=========================================================
                ...
                % Object location
                KineStruct_P.object = obj_location_P;
                KineStruct_Q.object = obj_location_Q;
