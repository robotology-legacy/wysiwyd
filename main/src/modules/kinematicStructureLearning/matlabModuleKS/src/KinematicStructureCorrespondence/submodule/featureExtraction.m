...
function cdata = featureExtraction(videoName)
...
switch videoName
    ...
    case 'video'
        ...
        [cdata.filename, cdata.pathname, filterindex] = uigetfile(...
            {'*.avi;*.mpg;*.mpeg;*.mp4','Video Files (*.avi,*.mpg,*.mpeg,*.mp4)';
            '*.*',  'All Files (*.*)'}, ...
            'Select a video file',...
            '/home/hjchang/Research/code/Matlab/cvpr2016/dataset/data');
        ...
        cdata.feature_point_save_path = [pwd,'/points/',cdata.filename(1:end-4)];
