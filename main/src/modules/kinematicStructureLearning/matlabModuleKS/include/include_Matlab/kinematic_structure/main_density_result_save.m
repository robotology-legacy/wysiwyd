...
% filename_buf = {'robot_arm.mp4.mat'};
% [filename, pathname, filterindex] = uigetfile('../dataset/*.mat');

pathname = '/home/hjchang/Research/code/Matlab/cvpr2015/dataset/';
% filename_buf = {'dancing','head','yellow_crane','puppet'};
% filename_buf = {'arm.avi','toy_truck','dancing','head','yellow_crane','puppet','iCub_motion.avi','iCub_hand.avi','robot_arm.mp4','baxter_cut.mp4','hand1.mp4'};
filename_buf = {'robot_arm.mp4','baxter_cut.mp4','hand1.mp4'};
...
%
% seg_center_buf = cell(num_iter,size(filename_buf,2));
% seg_idx_buf = cell(num_iter,size(filename_buf,2));
...
%             end
        ...
        if shape_ON
            ...
            if shape_SVDD_load_ON
                ...
                SVDD_shape_skeleton_density_update;
            end
        ...
        num_seg_total{iter,filename_idx} = num_seg_history;
        
        seg_center_buf{iter,filename_idx} = seg_center;
        seg_idx_buf{iter,filename_idx} = seg_idx;
