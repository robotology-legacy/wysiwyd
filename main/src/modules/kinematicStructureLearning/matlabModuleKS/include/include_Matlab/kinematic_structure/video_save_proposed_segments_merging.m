...
%%
video_save_path = '/home/hjchang/Research/code/Matlab/cvpr2015/result/proposed_result_video/iter_merge/';
...
for filename_idx = 1:size(filename_buf,2)
    ...
    for iter_idx = iter_idx_total
        ...
        for merge_idx = 1:empty_check_idx-1
            seg_idx = seg_idx_buf{merge_idx};
            ...
            writerobj_black = VideoWriter([video_save_path,videoFileName(1:end-4),'_result_black_',num2str(iter_idx),'_',num2str(num_seg)]);
