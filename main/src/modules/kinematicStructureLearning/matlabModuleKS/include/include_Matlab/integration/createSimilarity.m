function problem = createSimilarity(KineStruct_P, KineStruct_Q)
...
%             step = step + 1;
            ...
            if (id_i1 ~= id_j1) && (id_j1 ~= id_k1) && (id_k1 ~= id_i1)
                ...
                %                 feat1 = cal_motion_feat_batch_v2_1(KineStruct_P, id_i1, id_j1, id_k1, preCompMtxP, method) / 9.1514;
                feat1 = [preCompMtxP{id_i1,id_j1,1}.min,preCompMtxP{id_i1,id_j1,1}.max,preCompMtxP{id_j1,id_k1,1}.min,preCompMtxP{id_j1,id_k1,1}.max,preCompMtxP{id_k1,id_i1,1}.min,preCompMtxP{id_k1,id_i1,1}.max] / 9.1514;
                ...
                for id_k2 = 1:nP2
                    for id_j2 = 1:nP2
                        if (id_j2 ~= id_k2)
                            for id_i2 = 1:nP2                                
                                %                             if (id_i2 ~= id_j2) && (id_j2 ~= id_k2) && (id_k2 ~= id_i2)
                                if (id_i2 ~= id_j2) && (id_k2 ~= id_i2)
                                    ...
                                    %                                 feat2 = cal_motion_feat_batch_v2_1(KineStruct_Q, id_i2, id_j2, id_k2, preCompMtxQ, method) / 9.1514;
                                    feat2 = [preCompMtxQ{id_i2,id_j2,1}.min,preCompMtxQ{id_i2,id_j2,1}.max,preCompMtxQ{id_j2,id_k2,1}.min,preCompMtxQ{id_j2,id_k2,1}.max,preCompMtxQ{id_k2,id_i2,1}.min,preCompMtxQ{id_k2,id_i2,1}.max] / 9.1514;
