...
nSet=nSet+1; settings{nSet} = {1, 'Deformation noise \it\sigma\rm', 'deformation', 0.01};

nSet=nSet+1; settings{nSet} = {0, 'Point Distribution', 'typeDistribution', 'normal'}; % normal / uniform
nSet=nSet+1; settings{nSet} = {0, 'Transformation Scale', 'transScale', 1.01}; % scale change
