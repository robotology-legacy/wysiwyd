function img_output = genMatchImage(img_acc_P, img_acc_Q, KineStruct_P, KineStruct_Q, X, method)
...
%---------------------------------------------------------------
% img_acc_normalised_P = imresize(img_acc_P, [height_normalised, width_normalised]);
% img_combined(:,1:width_normalised) = img_acc_normalised_P;
% 
...
%---------------------------------------------------------------
% img_acc_normalised_Q_buf = imresize(img_acc_Q, [height_normalised, NaN]);
% width_norm_Q = size(img_acc_normalised_Q_buf,2);
% start_point_Q = floor((width_norm_Q - width_normalised) / 2);
% img_acc_normalised_Q = img_acc_normalised_Q_buf(:,start_point_Q:width_normalised+start_point_Q-1);
% img_combined(:,width_normalised+1:width_normalised+width_normalised) = img_acc_normalised_Q;
% 
% ratio_height_Q = height_normalised / KineStruct_Q.height;
% ratio_width_Q = width_norm_Q/ KineStruct_Q.width;
% 
% shifted_dist = width_normalised - start_point_Q;

%---------------------------------------------------------------
% img_acc_normalised_Q = imresize(img_acc_Q, [height_normalised, width_normalised]);
% img_combined(:,width_normalised+1:width_normalised+width_normalised) = img_acc_normalised_Q;
% ratio_height_Q = height_normalised / KineStruct_Q.height;
% ratio_width_Q = width_normalised/ KineStruct_Q.width;
% 
% shifted_dist = width_normalised;
