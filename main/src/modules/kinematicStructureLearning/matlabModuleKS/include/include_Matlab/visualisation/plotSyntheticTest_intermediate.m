...
acc_total_plot(1:idxTest,:,1) = acc_total(1:idxTest,:,5);
acc_total_plot(1:idxTest,:,2) = acc_total(1:idxTest,:,6);
acc_total_plot(1:idxTest,:,3) = acc_total(1:idxTest,:,2);
acc_total_plot(1:idxTest,:,4) = acc_total(1:idxTest,:,3);
acc_total_plot(1:idxTest,:,5) = acc_total(1:idxTest,:,4);
acc_total_plot(1:idxTest,:,6) = acc_total(1:idxTest,:,1);
...
%                 set(hLegend, 'Location', 'best', 'FontSize', 9);
        ...
        fig_save_name = ['/home/hjchang/Research/code/Matlab/cvpr2016/code/result/synthetic/graph/nodeAddTest_2D'];
        
    case 2  % for motion perturb
        show_legend = 1;
        if show_legend
            hLegend = legend(plotOption(:).strName);
            set(hLegend, 'Location', 'best');
        ...
        fig_save_name = ['/home/hjchang/Research/code/Matlab/cvpr2016/code/result/synthetic/graph/motionPerturbationTest_2D'];
    ...
    case 3  % for symmetry
        ...
        fig_save_name = ['/home/hjchang/Research/code/Matlab/cvpr2016/code/result/synthetic/graph/symmetryTest_2D'];
