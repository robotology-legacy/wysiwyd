...
6) Insert two new instances to the ABM, remember to replace TODAYSTIME and old_instance+1 / old_instance+2
6a) INSERT INTO main(activityname, activitytype, time, instance, begin, opcname) VALUES ('action', 'action', 'TODAYSTIME', old_instance+1, TRUE, 'OPC')
6b) INSERT INTO main(activityname, activitytype, time, instance, begin, opcname) VALUES ('action', 'action', 'TODAYSTIME', old_instance+2, TRUE, 'OPC')
7) In the exported file, search for ", 4533, " and replace with ", new_instance, "; remember not to change the instance in the filepath!
