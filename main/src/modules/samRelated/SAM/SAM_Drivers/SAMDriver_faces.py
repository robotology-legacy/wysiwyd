...
class SAMDriver_faces(SAMDriver):
...
#Outputs: None
#""""""""""""""""
    def __init__(self, isYarpRunning = isYarpRunningGlobal, imgH = 200, imgW = 200, imgHNew = 200, imgWNew = 200, inputImagePort="/visionDriver/image:o"):
...
#Outputs: None
#""""""""""""""""
    def prepareFaceData(self, model='mrd', Ntr = 50, pose_selection = 0, randSeed=0):    
        ...
        #Call super class to finish preparation
        self.prepareData(model=model, Ntr = Ntr, randSeed=randSeed)
