...
[trainConf, trainPerc]=testingSegments.testSegments(mySAMpy, yTrainingData, Lall)

yTrainingData = mySAMpy.formatDataFunc(YtestAll)
[testConf, testPerc] = testingSegments.testSegments(mySAMpy, yTrainingData, LtestAll)
print
