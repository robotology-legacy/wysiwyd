...
Bottle Bodypart::asBottle()
{
    ...
    bSub.addDouble(m_joint_number);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString("tactile_number");
    bSub.addDouble(m_tactile_number);
    b.addList() = bSub;
...
bool Bodypart::fromBottle(Bottle b)
{
    ...
    m_joint_number   = b.find("joint_number").asDouble();
    m_tactile_number = b.find("tactile_number").asDouble();
    return true;
}
